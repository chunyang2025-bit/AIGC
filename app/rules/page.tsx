    ...
    <main className="main">
      <section className="card">
        <div className="cardBody stack">
          ...
          <p className="muted">为保证派单需求真实、接单信息可信，平台对入驻主体和公开内容实行基础认证与风控。</p>
          <div className="briefBlock">
            <strong>派单方规则</strong>
            <p>派单方需提交主体名称、联系方式和有效资质。试运营期间可先发布需求并邀请接单方沟通；未认证会展示风险提示，认证通过后进入更完整的公开展示。</p>
          </div>
          <div className="briefBlock">
            <strong>接单方规则</strong>
            <p>接单方可先基础入驻、浏览公开需求并发送展示页；未认证会展示风险提示，认证通过后更容易被派单方信任。</p>
          </div>
          <div className="briefBlock">
